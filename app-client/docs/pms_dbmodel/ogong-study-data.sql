...
스터디 관련 주의사항 : 저도 이제 막 시작하려고 합니다. 함께 맨 땅에 헤딩할 동료분을 찾아요. 영문 자료가 많아서 영어는 어느정도 필요해보입니다. ', '2021-11-2', 2, 1, '서울시');
...
insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status, area) 
values(20, '웹디자인기능사 실기시험 완벽 가이드 완강까지 함께 하실 분~!', 2, 13, 3, '스터디 주제 : 웹디자인 기능사 실기 공부
