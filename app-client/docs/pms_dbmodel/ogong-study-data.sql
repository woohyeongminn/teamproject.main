...
스터디 관련 주의사항 : 열심히 하실 분만 신청 바랍니다', '2021-11-3', 1, 1);
...
스터디 관련 주의사항 : 저도 이제 막 시작하려고 합니다. 함께 맨 땅에 헤딩할 동료분을 찾아요. 영문 자료가 많아서 영어는 어느정도 필요해보입니다. ', '2021-11-4', 2, 2, '서울시');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(3, '영어 공부 하실 분', 1, 2, 1, '진지하게 영어 공부하실 분만 신청 바랍니다', '2021-11-6', 3, 1);
...
스터디 관련 주의사항 : 진지하게 오래 하실 분을 희망합니다.', '2021-11-6', 4, 2, '강남구');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(5, '기타 치실 분', 5, 10, 2, '기타 잘 못 쳐도 환영합니다 같이 배워요', '2021-11-7', 5, 1);

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status, area) 
values(6, '주말 등산 스터디', 6, 12, 3, '등산은 장비빨', '2021-11-8', 6, 2, '안양시');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(7, '프랑스어 공부 하실 분', 1, 14, 1, '열심히 참여하실 분 환영 합니다', '2021-11-9', 7, 1);
...
스터디 관련 주의사항 : CS, Java, Spring 모의 면접 스터디이기 때문에 아예 모르시는 분은 정말 죄송하지만 힘들 것 같습니다. 각자 주어진 키워드를 공부하고 모의 면접 때 대답하면서 부족한 부분을 채워갔으면 좋겠습니다. 정말 열심히 하실분들만 지원하셨으면 좋겠습니다 !', '2021-9-1', 9, 1);
...
스터디 관련 주의사항 : 코딩과 알고리즘에 열심이신 분들만 오셨으면 좋겠습니다. ', '2021-10-1', 10, 2, '양주시');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(11, '에어로빅 배우실 분 구해요', 5, 22, 2, '몸치 대환영', '2021-11-1', 11, 1);

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status, area) 
values(12, '식물 키우기 스터디 모집', 6, 24, 3, '식물 자주 죽이시는 분 대환영', '2021-11-2', 12, 2, '평택시');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(13, '독일어 공부 하실 분', 1, 26, 1, '성실하게 참여하실 분 아니면 신청하지도 마세요', '2021-11-3', 13, 1);
...
방학을 실용적인 활동을 통해 알차고 슬기롭게 보내고 싶으신 분 신청해주시기 바랍니다! 또한 온라인으로 스터디를 진행하고자 합니다. 자세한 일정은 함께 정해요!', '2021-11-4', 14, 2, '제주시');
...
values(15, '취업용 포트폴리오 스터디 모집', 3, 30, 3, '
    ...
    스터디 관련 주의사항 : 2~3달간 스터디에 시간을 쏟으실 수 있으신분', '2021-11-5', 15, 1);
...
values(16, '스프링인액션 제5판', 4, 5, 1, '
    ...
    스터디 소개와 개설 이유 : 함께 마음맞는 분들과 스터디를 진행하며 실력향상을 도모하고 싶습니다!', '2021-11-6', 1, 2, '강원도');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(17, '스우파 헤이마마 춤 마스터', 5, 15, 2, '스우파 애청자 대환영', '2021-11-7', 1, 1);

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status, area) 
values(18, '클래식 독서 모임', 6, 25, 3, '클래식 들으며 같이 책 읽어요', '2021-11-8', 1, 2, '전라도');

insert into study(
study_no, name, subject_no, no_people, face_no, introduction, created_dt, member_no, status) 
values(19, '일본어 공부 하실 분', 1, 3, 2, '수강 인증 날짜 잘 지키시면 좋겠습니다', '2021-11-9', 1, 1);
...
스터디 관련 주의사항 : 성실히 참여하실 분들만 모집합니다.', '2021-11-10', 1, 2, '부천시');
...
values(1,1,'2021-11-3',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(2,2,'2021-11-4',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(3,3,'2021-11-5',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(4,4,'2021-11-6',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(5,5,'2021-11-7',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(6,6,'2021-11-8',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(7,7,'2021-11-9',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(8,8,'2021-11-10',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(9,9,'2021-9-1',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(10,10,'2021-10-1',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(11,11,'2021-11-1',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(12,12,'2021-11-2',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(13,13,'2021-11-3',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(14,14,'2021-11-4',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(15,15,'2021-11-5',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(16,16,'2021-11-6',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(17,17,'2021-11-7',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(18,18,'2021-11-8',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(19,19,'2021-11-9',2);

insert into study_guilder(member_no,study_no,created_dt,status) 
values(20,20,'2021-11-10',2);
