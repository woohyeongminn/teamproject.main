...
public class StudyIngListHandler implements Command {

  StudyDao studyDao;

  public StudyIngListHandler(StudyDao studyDao) {
  ...
  public void execute(CommandRequest request) throws Exception {
    System.out.println();
    System.out.println("▶ 스터디 목록 - 진행중");
    System.out.println();


    List<Study> studyList = studyDao.findAllIng();
