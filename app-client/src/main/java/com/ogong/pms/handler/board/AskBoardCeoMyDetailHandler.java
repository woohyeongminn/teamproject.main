...
public class AskBoardCeoMyDetailHandler implements Command {
  ...
  public AskBoardCeoMyDetailHandler(RequestAgent requestAgent) {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    params.put("ceoMemberNo", String.valueOf(ceoMember.getCeoNo()));

    requestAgent.request("askBoard.ceoMy.selectOne", params);
