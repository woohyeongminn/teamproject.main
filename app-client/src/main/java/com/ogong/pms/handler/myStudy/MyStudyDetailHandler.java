...
public class MyStudyDetailHandler implements Command {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    HashMap<String,String> paramsMyStudy = new HashMap<>();
    paramsMyStudy.put("studyNo", String.valueOf(inputNo));

    requestAgent.request("study.selectOne", paramsMyStudy);
    ...
    if (!myStudy.getOwner().getPerNickname().equals(member.getPerNickname())) {
      ...
      return;
        ...
        myStudy.getOwner().getPerNickname().equals(member.getPerNickname())) {
      ...
      request.setAttribute("studyNo", inputNo);
