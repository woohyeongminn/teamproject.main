...
//
//// 소켓통신용 서버 코드
//public class MySocketServer extends Thread implements Command {
//  static ArrayList<Socket> list = new ArrayList<Socket>(); // 유저 확인용
//  static Socket socket = null;
//  RequestAgent requestAgent;
//
//  public MySocketServer(Socket socket, RequestAgent requestAgent) {
...
//        Thread thd = new MySocketServer(socketUser, requestAgent);
//        thd.start(); // Thread 시작
//      }                 
//
//    } catch (IOException e) {
