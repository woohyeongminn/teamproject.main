...
public class AppConfig {
  ...
  public SqlSessionFactory sqlSessionFactory(
    ...
    // 
    sqlSessionFactoryBean.setTypeAliasesPackage("com.ogong.pms.domain");
    sqlSessionFactoryBean.setMapperLocations(
        appCtx.getResources("classpath:com/ogong/pms/dao/*Dao.xml"));
