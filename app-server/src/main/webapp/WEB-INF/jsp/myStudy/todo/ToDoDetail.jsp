          ...
          <div class="row">
           ...
           <div class="allbox">
				  ...
				  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
				      <button class="btn btn-outline-dark"><a href="list?studyno=${study.studyNo}">목록</a></button>
				      <c:if test='${todo.todoWriter.perNickname eq member.perNickname}'>
				      <button class="btn btn-outline-dark"><a href="delete?todono=${todo.todoNo}&studyno=${study.studyNo}">삭제</a></button>
				      </c:if>
				  </div>
