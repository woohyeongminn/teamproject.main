...
<!-- <i id="icon" class="far fa-envelope"></i> -->
    ...
    margin-top: 10px;"></h4>
	  ...
	  <iframe src="https://service.dongledongle.com/study-ogong" frameborder="0" width="100%" height="470px;"></iframe>
	  ...
	  <div class="choice" style="display: block; text-align: right; margin-right: 20px;">
		  ...
		  <a href="javascript:close()" id="btnJoin" class="btn btn-outline-dark" style="font-size: 12px; line-height: 12px;">돌아가기</a>
	  </div>
...
function close() {
	if (window.opener && !window.opener.closed) {
		window.opener.location = "${contextPath}/app/study/list";
		window.close();
	}
};
</script>
