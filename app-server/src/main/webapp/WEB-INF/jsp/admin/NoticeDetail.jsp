          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3" style="background-color: #5b5b5b; box-shadow: 0 4px 20px 0 rgb(0 0 0 / 14%), 0 7px 10px -5px rgb(91 91 91 / 40%) !important;">
                <h6 class="text-white text-capitalize ps-3">${adminNotice.adminNotiTitle}</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
								  ...
								  <tr id="first">
								    ...
								    <th scope="col" id="title"><input id='f-title' type='text' name='title' value="${adminNotice.adminNotiTitle}" readonly></th>
