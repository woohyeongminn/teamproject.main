              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  ...
                  <tr id="first">
                    ...
                    <th scope="col" id="title"><input id='f-title' type='text' name='adminNotiTitle' placeholder="제목을 입력해 주세요." autocomplete='off'></th>
                    <th scope="col"></th>
                  </tr>
  
                  <tr id="blockbox">
                    <th scope="row" id="second"><label for='f-content' id="content">내용</label></th>
                    <th scope="col"><textarea id='f-content' name='adminNotiContent' rows="20" wrap="virtual" autocomplete='off' placeholder="내용을 입력해 주세요."></textarea></td>
                    <th></th>
                  </tr>
                  
                  <tr id="blockbox">
                    <th scope="row" id="third"><label for='f-filepath'>파일</label></th>
                    <th scope="col"><img style="width: 200px;" id="preview-image" src="https://dummyimage.com/200x200/ffffff/000000.png&text=preview">
									    <div class="button">
