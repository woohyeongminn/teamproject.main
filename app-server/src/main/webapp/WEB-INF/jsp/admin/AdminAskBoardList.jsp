        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="bg-gradient-success shadow-success border-radius-lg pt-4 pb-3" style="background-color: #49a3f1;box-shadow: 0 4px 20px 0 rgb(0 0 0 / 14%), 0 7px 10px -5px rgb(73 163 241 / 40%) !important;">
                <h6 class="text-white text-capitalize ps-3">Ask Board</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">&emsp;제목</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">&emsp;작성자</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">답변</th>
								...
								<c:forEach items="${adminAskBoardList}" var="askBoard">
								 <c:choose>
								  <c:when test="${askBoard.askMemberWriter.perStatus == 1}">
										<tr>
										 <td>
                       <p class="text-xs font-weight-bold mb-0" style="padding: 0.75rem 0 0.75rem 1.5rem;">${askBoard.askNo}</p>
                     </td>
                     <td>
                       <div class="d-flex px-2 py-1">
                         <div class="d-flex flex-column justify-content-center">
                           <h6 class="mb-0 text-sm" style="color:#4e4847;"><a href='detail?askNo=${askBoard.askNo}'>${askBoard.askTitle}</a></h6>
                         </div>
                       </div>
                     </td>
                     <td>
                       <p class="text-xs font-weight-bold mb-0" style="padding: 0.75rem 0 0.75rem 1.5rem;">[개인]${askBoard.askMemberWriter.perNickname}</p>
                     </td>
                     <td>
                       <p class="text-xs font-weight-bold mb-0" style="padding: 0.75rem 0 0.75rem 1.5rem;">${askBoard.askVeiwCount}</p>
                     </td>
                     <td class="align-middle text-center">
                       <span class="text-secondary text-xs font-weight-bold">${askBoard.askRegisteredDate}</span>
                     </td>
							       <c:choose>
                      ...
                      <td>
                       <a href='delete?askNo=${askBoard.askNo}' class="text-secondary font-weight-bold text-xs" style="padding-left: 25px;">
                         삭제
                       </a>
                      </td>
                    </tr>
                  ...
                  <c:when test="${askBoard.askCeoWriter.ceoStatus == 2}">
                    <tr>
                     ...
                     <td>
                       <p class="text-xs font-weight-bold mb-0" style="padding: 0.75rem 0 0.75rem 1.5rem;">[사장]${askBoard.askCeoWriter.ceoNickname}</p>
                     </td>
                     <td>
                       <p class="text-xs font-weight-bold mb-0" style="padding: 0.75rem 0 0.75rem 1.5rem;">${askBoard.askVeiwCount}</p>
                     </td>
