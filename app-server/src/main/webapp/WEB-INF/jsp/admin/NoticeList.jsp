                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <c:forEach items="${adminNoticeList}" var="noticeList">
                      <tr>
                        <td>
                          <p class="text-xs font-weight-bold mb-0" style="padding: 0.75rem 0 0.75rem 1.5rem;">${noticeList.adminNotiNo}</p>
                        </td>
                        <td>
                          <div class="d-flex px-2 py-1">
                            <div class="d-flex flex-column justify-content-center">
                              <h6 class="mb-0 text-sm" style="color:#4e4847;"><a href='detail?no=${noticeList.adminNotiNo}'>${noticeList.adminNotiTitle}</a></h6>
                            </div>
                          </div>
                        </td>
                        <td class="align-middle text-center">
                          <span class="text-secondary text-xs font-weight-bold">${noticeList.adminNotiRegisteredDate}</span>
                        </td>
                        <td class="align-middle">
                          <a href='delete?no=${noticeList.adminNotiNo}' class="text-secondary font-weight-bold text-xs" style="padding-left: 25px;">
                            삭제
                          </a>
                        </td>                    
                      </tr>
