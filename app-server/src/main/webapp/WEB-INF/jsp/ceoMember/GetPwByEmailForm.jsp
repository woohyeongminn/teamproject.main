...
<body>
  <div class="all-content"><br>
    ...
    <form id="ceoMember-form" action='getpwbyemail' name='ceoInfo' method='post' >

      <div id="mn">
        <label id='f-name' for='f-name' class="col-sm-2 col-form-label">이름</label>
        <input id='i-name' type='text' name='ceoName' placeholder="*필수"/><br>
      </div>

      <div id="me">
        <label id='f-email' for='f-email' class="col-sm-2 col-form-label">이메일</label>
        <input id='i-email' type='text' name='ceoEmail' pattern="^[a-zA-Z0-9]+$" placeholder="*필수" onkeydown="inputEmail()"/> @ 
        <select name="site">
